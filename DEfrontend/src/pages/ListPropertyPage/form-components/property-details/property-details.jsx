        ...
        <div className="property-details">
            <div className="property-details-form">
                ...
                <div>
                    ...
                    <textarea required type="textarea" name="Property_Description" className="text-area" rows="7" cols="100" onChange={event => handleChange(event)} defaultValue="Add a description for your property to attract the best tenant">
                    </textarea>
                </div>
